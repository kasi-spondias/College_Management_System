    ...
    <div class="row m40_0">
        ...
        <table class="table table-bordered" id="pages">
            ...
            <tbody>
            	<?php
					$i=1;
					$query = $db->query("select * from questions ORDER BY id DESC") or die(mysqli_error());
					while($row = mysqli_fetch_assoc($query)){
						...
						echo '<td><a href="edit-faculty-questions.php?id='.$row['id'].'" class="btn btn-sm btn-warning">Edit</a>&nbsp;&nbsp;&nbsp;<a href="delete.php?que_id='.$row['id'].'" class="btn btn-sm btn-danger">Delete</a></td>';
						echo '</tr>';
						$i++;	
					}
				?> 	
