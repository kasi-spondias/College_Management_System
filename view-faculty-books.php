        ...
        <table class="table table-bordered table-responsive table-bg" id="pages">
               ...
               $id = 1;
                while($row=mysqli_fetch_array($query)) 
                {
					...
					?>
                    <?php echo "<td align='center'><a href='edit_fac_ref_books.php?id=".$row['id']."' class='btn btn-sm btn-warning'>Edit</a>&nbsp;&nbsp;<a href='delete.php?ref_books_id=".$row['id']."' class='btn btn-sm btn-danger'>Delete</a></td>";
                    echo "</tr>";
                    $id++;
                } 
                ?>
