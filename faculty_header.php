          ...
          <ul class="nav navbar-nav">
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="ad-faculty-books.php">ADD REFERENCE BOOKS</a></li>
                <li><a href="view-faculty-books.php">VIEW REFERENCE BOOKS</a></li>
              </ul>
             </li>
             <li><a href="view-queries-complaints.php">COMPLAINTS</a></li>
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="add-faculty-exam.php">ADD EXAMS</a></li>
                <li><a href="view-faculty-exam.php">VIEW EXAMS</a></li>
              </ul>
             </li>
			 <li class="dropdown">
			  ...
			  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">INTERNAL MARKS<span class="caret"></span></a>
                       <ul class="dropdown-menu">
                          <li><a href="add_stu_marks.php">ADD MARKS</a>
				               	
							</li>							
                          <li><a href="view_fs_marks.php">VIEW MARKS</a></li>
              </ul>
             </li>
			 <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="view-faculty-exam-results.php">VIEW MARKS</a></li>
              </ul>
             </li>
             <li><a href="view-faculty-questions.php">QUESTIONS</a></li>
          </ul>
