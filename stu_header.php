  ...
  <div class="row">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
             ...
             <li><a href="stu-books.php">VIEW REFERENCE BOOKS</a></li>
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="add-queries-complaints.php">ADD QUERIES/COMPLAINTS</a></li>
                <li><a href="view_stu-queries-complaints.php">VIEW QUERIES/COMPLAINTS</a></li>
              </ul>
             </li>
			 <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">ATTENDANCE<span class="caret"></span></a>
                       <ul class="dropdown-menu">
                          <li><a href="view_stu_attendance.php">VIEW ATTENDANCE</a></li>							
			  ...
			  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MARKS<span class="caret"></span></a>
                       <ul class="dropdown-menu">
                          <li><a href="view_stu_marks.php">VIEW MARKS</a></li>							
              </ul>
             </li>
             <li><a href="stu_exam_main.php">EXAMS</a></li>
			 <li><a href="stu-exam-results.php">VIEW MARKS</a></li>
