...
<!-- Start Content -->
    ...
    <div class="row m40_0">
        <div class="contact_form_text" style="margin-top:20px;">VIEW STUDENT DETAILS</div>
        ...
        <table class="table table-bordered table-responsive table-bg" id="pages">
                ...
                <tbody>
               <?php 
               $query = $db->query("select * from student_register ORDER BY id DESC") or die(mysqli_error());
               $id = 1;
